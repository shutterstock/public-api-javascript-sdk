...
*shutterstock-api.EditorialImagesApi* | [**getEditorialImageDetails**](https://github.com/shutterstock/public-api-javascript-sdk/blob/master/docs/EditorialImagesApi.md#getEditorialImageDetails) | **GET** /v2/editorial/images/{id} | Get editorial content details
...
*shutterstock-api.EditorialImagesApi* | [**getEditorialLivefeedImageItems**](https://github.com/shutterstock/public-api-javascript-sdk/blob/master/docs/EditorialImagesApi.md#getEditorialLivefeedImageItems) | **GET** /v2/editorial/images/livefeeds/{id}/items | Get editorial livefeed items
...
*shutterstock-api.EditorialVideoApi* | [**editorialVideosDetails**](https://github.com/shutterstock/public-api-javascript-sdk/blob/master/docs/EditorialVideoApi.md#editorialVideosDetails) | **GET** /v2/editorial/videos/{id} | Get editorial video content details
*shutterstock-api.EditorialVideoApi* | [**editorialVideosSearch**](https://github.com/shutterstock/public-api-javascript-sdk/blob/master/docs/EditorialVideoApi.md#editorialVideosSearch) | **GET** /v2/editorial/videos/search | Search editorial video content
*shutterstock-api.EditorialVideoApi* | [**getEditorialCategories**](https://github.com/shutterstock/public-api-javascript-sdk/blob/master/docs/EditorialVideoApi.md#getEditorialCategories) | **GET** /v2/editorial/videos/categories | List editorial video categories

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ShutterstockApiReference.InlineResponse200AssetsHugeJpg = factory(root.ShutterstockApiReference.ApiClient);
  }
  ...
  /**
   * The InlineResponse200AssetsHugeJpg model module.
   * @module model/InlineResponse200AssetsHugeJpg
   * @version 1.1.42
   */

  /**
   * Constructs a new <code>InlineResponse200AssetsHugeJpg</code>.
   * Image size information
   * @alias module:model/InlineResponse200AssetsHugeJpg
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse200AssetsHugeJpg</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse200AssetsHugeJpg} obj Optional instance to populate.
   * @return {module:model/InlineResponse200AssetsHugeJpg} The populated <code>InlineResponse200AssetsHugeJpg</code> instance.
   */

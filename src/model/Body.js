...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ShutterstockApiReference.Body = factory(root.ShutterstockApiReference.ApiClient);
  }
   ...
   * @member {Array.<module:model/Body.ImageTypeEnum>} image_type
   */
   ...
   * @member {module:model/Body.LanguageEnum} language
   */
  exports.prototype['language'] = undefined;
  /**
   * Show only images with the specified license
   * @member {Array.<module:model/Body.LicenseEnum>} license
   */
   ...
   * @member {module:model/Body.OrientationEnum} orientation
   */
   ...
   * @member {module:model/Body.PeopleAgeEnum} people_age
   */
   ...
   * @member {Array.<module:model/Body.PeopleEthnicityEnum>} people_ethnicity
   */
  exports.prototype['people_ethnicity'] = undefined;
  /**
   * Show images with people of the specified gender
   * @member {module:model/Body.PeopleGenderEnum} people_gender
   */
  ...
  /**
   * Sort by
   * @member {module:model/Body.SortEnum} sort
   * @default 'popular'
   */
   ...
   * @member {module:model/Body.ViewEnum} view
   * @default 'minimal'
   */

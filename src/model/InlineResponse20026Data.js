...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/InlineResponse20025Data', '../model/InlineResponse20026RoleAssignments'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse20025Data'), require('./InlineResponse20026RoleAssignments'));
  } else {
    // Browser globals (root is window)
    if (!root.ShutterstockApiReference) {
      root.ShutterstockApiReference = {};
    }
    root.ShutterstockApiReference.InlineResponse20026Data = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.InlineResponse20025Data, root.ShutterstockApiReference.InlineResponse20026RoleAssignments);
  }
}(this, function(ApiClient, InlineResponse20025Data, InlineResponse20026RoleAssignments) {
  'use strict';
   ...
   * @param visibility {module:model/InlineResponse20026Data.VisibilityEnum} 
   * @param role_assignments {module:model/InlineResponse20026RoleAssignments} 
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('cover_asset')) {
        obj['cover_asset'] = InlineResponse20025Data.constructFromObject(data['cover_asset']);
      }
      ...
      if (data.hasOwnProperty('role_assignments')) {
        obj['role_assignments'] = InlineResponse20026RoleAssignments.constructFromObject(data['role_assignments']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/InlineResponse20025Data} cover_asset
   */
  ...
  /**
   * @member {module:model/InlineResponse20026Data.VisibilityEnum} visibility
   */
  exports.prototype['visibility'] = undefined;
  /**
   * @member {module:model/InlineResponse20026RoleAssignments} role_assignments
   */

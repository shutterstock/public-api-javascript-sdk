...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Shutterstock.UpdatedMedia = factory(root.Shutterstock.ApiClient);
  }
   ...
   * @param updatedTime {Date} Date the media was updated
   * @param updates {Array.<String>} List of updates
   */
  var exports = function(id, updatedTime, updates) {
    var _this = this;

    _this['id'] = id;
    _this['updated_time'] = updatedTime;

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ShutterstockApiReference.V2audiolicensesAudio = factory(root.ShutterstockApiReference.ApiClient);
  }
  ...
  /**
   * The V2audiolicensesAudio model module.
   * @module model/V2audiolicensesAudio
   * @version 1.1.42
   */

  /**
   * Constructs a new <code>V2audiolicensesAudio</code>.
   * An audio track in a licensing request
   * @alias module:model/V2audiolicensesAudio
   * @class
  ...
  /**
   * Constructs a <code>V2audiolicensesAudio</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V2audiolicensesAudio} obj Optional instance to populate.
   * @return {module:model/V2audiolicensesAudio} The populated <code>V2audiolicensesAudio</code> instance.
   */
  ...
  /**
   * Type of license
   * @member {module:model/V2audiolicensesAudio.LicenseEnum} license
   */

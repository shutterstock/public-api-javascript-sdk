...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ShutterstockApiReference.V2sfxlicensesSoundEffects = factory(root.ShutterstockApiReference.ApiClient);
  }
  ...
  /**
   * The V2sfxlicensesSoundEffects model module.
   * @module model/V2sfxlicensesSoundEffects
   * @version 1.2.0
   */

  /**
   * Constructs a new <code>V2sfxlicensesSoundEffects</code>.
   * 
   * @alias module:model/V2sfxlicensesSoundEffects
   * @class
  ...
  /**
   * Constructs a <code>V2sfxlicensesSoundEffects</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V2sfxlicensesSoundEffects} obj Optional instance to populate.
   * @return {module:model/V2sfxlicensesSoundEffects} The populated <code>V2sfxlicensesSoundEffects</code> instance.
   */
  ...
  /**
   * @member {module:model/V2sfxlicensesSoundEffects.AudioLayoutEnum} audio_layout
   */
  exports.prototype['audio_layout'] = undefined;
  /**
   * @member {module:model/V2sfxlicensesSoundEffects.FormatEnum} format
   */

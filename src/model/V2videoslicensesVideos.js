...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/V2videoslicensesAuthCookie'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./V2videoslicensesAuthCookie'));
  } else {
    // Browser globals (root is window)
    if (!root.ShutterstockApiReference) {
      root.ShutterstockApiReference = {};
    }
    root.ShutterstockApiReference.V2videoslicensesVideos = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.V2videoslicensesAuthCookie);
  }
}(this, function(ApiClient, V2videoslicensesAuthCookie) {
  'use strict';
  ...
  /**
   * The V2videoslicensesVideos model module.
   * @module model/V2videoslicensesVideos
   * @version 1.1.42
   */

  /**
   * Constructs a new <code>V2videoslicensesVideos</code>.
   * Data required to license a video
   * @alias module:model/V2videoslicensesVideos
   * @class
  ...
  /**
   * Constructs a <code>V2videoslicensesVideos</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V2videoslicensesVideos} obj Optional instance to populate.
   * @return {module:model/V2videoslicensesVideos} The populated <code>V2videoslicensesVideos</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('auth_cookie')) {
        obj['auth_cookie'] = V2videoslicensesAuthCookie.constructFromObject(data['auth_cookie']);
      }
  ...
  /**
   * @member {module:model/V2videoslicensesAuthCookie} auth_cookie
   */
   ...
   * @member {module:model/V2videoslicensesVideos.SizeEnum} size
   */

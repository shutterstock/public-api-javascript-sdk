...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Shutterstock.LicenseEditorialContentRequest = factory(root.Shutterstock.ApiClient, root.Shutterstock.LicenseEditorialContent);
  }
   ...
   * @class
   * @param country {String} 3-letter country code for where the editorial content will be distributed; this mandatory value is used for rights checks
  ...
  /**
   * 3-letter country code for where the editorial content will be distributed; this mandatory value is used for rights checks

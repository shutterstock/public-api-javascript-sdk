...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Shutterstock.DownloadHistory = factory(root.Shutterstock.ApiClient, root.Shutterstock.DownloadHistoryMediaDetails, root.Shutterstock.DownloadHistoryUserDetails);
  }
   ...
   * @class
   * @param downloadTime {Date} Date the media was downloaded the first time, in the format YYYY-MM-DDThh:mm:ssZ
   * @param id {String} ID of the download
   * @param license {String} The name of the license of this download
   */
  var exports = function(downloadTime, id, license) {
    var _this = this;


    _this['download_time'] = downloadTime;
    _this['id'] = id;

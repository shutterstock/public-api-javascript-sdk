...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/DownloadHistoryMediaDetails', '../model/DownloadHistoryRevshareDetails', '../model/DownloadHistoryUserDetails'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DownloadHistoryMediaDetails'), require('./DownloadHistoryRevshareDetails'), require('./DownloadHistoryUserDetails'));
  } else {
    // Browser globals (root is window)
    if (!root.ShutterstockApiReference) {
      root.ShutterstockApiReference = {};
    }
    root.ShutterstockApiReference.DownloadHistory = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.DownloadHistoryMediaDetails, root.ShutterstockApiReference.DownloadHistoryRevshareDetails, root.ShutterstockApiReference.DownloadHistoryUserDetails);
  }
}(this, function(ApiClient, DownloadHistoryMediaDetails, DownloadHistoryRevshareDetails, DownloadHistoryUserDetails) {
  'use strict';

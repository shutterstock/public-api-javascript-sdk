...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/LicenseImageCustomDimensions', '../model/V2videoslicensesAuthCookie'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./LicenseImageCustomDimensions'), require('./V2videoslicensesAuthCookie'));
  } else {
    // Browser globals (root is window)
    if (!root.ShutterstockApiReference) {
      root.ShutterstockApiReference = {};
    }
    root.ShutterstockApiReference.LicenseImage = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.LicenseImageCustomDimensions, root.ShutterstockApiReference.V2videoslicensesAuthCookie);
  }
}(this, function(ApiClient, LicenseImageCustomDimensions, V2videoslicensesAuthCookie) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('custom_dimensions')) {
        obj['custom_dimensions'] = LicenseImageCustomDimensions.constructFromObject(data['custom_dimensions']);
      }
  ...
  /**
   * @member {module:model/LicenseImageCustomDimensions} custom_dimensions
   */

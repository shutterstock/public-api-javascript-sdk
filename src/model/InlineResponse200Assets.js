...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ShutterstockApiReference.InlineResponse200Assets = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.InlineResponse200AssetsHugeJpg, root.ShutterstockApiReference.InlineResponse200AssetsHugeThumb);
  }
  ...
  /**
   * The InlineResponse200Assets model module.
   * @module model/InlineResponse200Assets
   * @version 1.1.42
   */

  /**
   * Constructs a new <code>InlineResponse200Assets</code>.
   * Image asset information
   * @alias module:model/InlineResponse200Assets
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse200Assets</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse200Assets} obj Optional instance to populate.
   * @return {module:model/InlineResponse200Assets} The populated <code>InlineResponse200Assets</code> instance.
   */

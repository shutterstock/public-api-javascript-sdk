...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/InlineResponse20014Categories', '../model/InlineResponse20021Assets'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse20014Categories'), require('./InlineResponse20021Assets'));
  } else {
    // Browser globals (root is window)
    if (!root.ShutterstockApiReference) {
      root.ShutterstockApiReference = {};
    }
    root.ShutterstockApiReference.InlineResponse20021Data = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.InlineResponse20014Categories, root.ShutterstockApiReference.InlineResponse20021Assets);
  }
}(this, function(ApiClient, InlineResponse20014Categories, InlineResponse20021Assets) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('assets')) {
        obj['assets'] = InlineResponse20021Assets.constructFromObject(data['assets']);
      }
  ...
  /**
   * @member {module:model/InlineResponse20021Assets} assets
   */

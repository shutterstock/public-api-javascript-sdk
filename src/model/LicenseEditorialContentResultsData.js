...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ShutterstockApiReference.LicenseEditorialContentResultsData = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.LicenseEditorialContentResultDownload);
  }
  ...
  /**
   * The LicenseEditorialContentResultsData model module.
   * @module model/LicenseEditorialContentResultsData
   * @version 1.1.42
   */

  /**
   * Constructs a new <code>LicenseEditorialContentResultsData</code>.
   * The response to a licensing request for editorial content
   * @alias module:model/LicenseEditorialContentResultsData
   * @class
  ...
  /**
   * Constructs a <code>LicenseEditorialContentResultsData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LicenseEditorialContentResultsData} obj Optional instance to populate.
   * @return {module:model/LicenseEditorialContentResultsData} The populated <code>LicenseEditorialContentResultsData</code> instance.
   */

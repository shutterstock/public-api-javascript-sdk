...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/InlineResponse2005CoverItem', '../model/InlineResponse200Errors'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2005CoverItem'), require('./InlineResponse200Errors'));
  } else {
    // Browser globals (root is window)
    if (!root.ShutterstockApiReference) {
      root.ShutterstockApiReference = {};
    }
    root.ShutterstockApiReference.CollectionItemDataList = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.InlineResponse2005CoverItem, root.ShutterstockApiReference.InlineResponse200Errors);
  }
}(this, function(ApiClient, InlineResponse2005CoverItem, InlineResponse200Errors) {
  'use strict';

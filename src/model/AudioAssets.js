...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/AudioAssetDetails', '../model/ShortsLoopsStems'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AudioAssetDetails'), require('./ShortsLoopsStems'));
  } else {
    // Browser globals (root is window)
    if (!root.ShutterstockApiReference) {
      root.ShutterstockApiReference = {};
    }
    root.ShutterstockApiReference.AudioAssets = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.AudioAssetDetails, root.ShutterstockApiReference.ShortsLoopsStems);
  }
}(this, function(ApiClient, AudioAssetDetails, ShortsLoopsStems) {
  'use strict';

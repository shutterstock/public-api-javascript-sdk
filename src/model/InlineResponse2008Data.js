...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/InlineResponse2008Album', '../model/InlineResponse2008Artists', '../model/InlineResponse2008Assets', '../model/InlineResponse200Contributor', '../model/InlineResponse200ModelReleases'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2008Album'), require('./InlineResponse2008Artists'), require('./InlineResponse2008Assets'), require('./InlineResponse200Contributor'), require('./InlineResponse200ModelReleases'));
  } else {
    // Browser globals (root is window)
    if (!root.ShutterstockApiReference) {
      root.ShutterstockApiReference = {};
    }
    root.ShutterstockApiReference.InlineResponse2008Data = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.InlineResponse2008Album, root.ShutterstockApiReference.InlineResponse2008Artists, root.ShutterstockApiReference.InlineResponse2008Assets, root.ShutterstockApiReference.InlineResponse200Contributor, root.ShutterstockApiReference.InlineResponse200ModelReleases);
  }
}(this, function(ApiClient, InlineResponse2008Album, InlineResponse2008Artists, InlineResponse2008Assets, InlineResponse200Contributor, InlineResponse200ModelReleases) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('album')) {
        obj['album'] = InlineResponse2008Album.constructFromObject(data['album']);
      }
      if (data.hasOwnProperty('artists')) {
        obj['artists'] = ApiClient.convertToType(data['artists'], [InlineResponse2008Artists]);
      }
      if (data.hasOwnProperty('assets')) {
        obj['assets'] = InlineResponse2008Assets.constructFromObject(data['assets']);
      }
      ...
      if (data.hasOwnProperty('similar_artists')) {
        obj['similar_artists'] = ApiClient.convertToType(data['similar_artists'], [InlineResponse2008Artists]);
      }
  ...
  /**
   * @member {module:model/InlineResponse2008Album} album
   */
  exports.prototype['album'] = undefined;
  /**
   * List of artists
   * @member {Array.<module:model/InlineResponse2008Artists>} artists
   */
  exports.prototype['artists'] = undefined;
  /**
   * @member {module:model/InlineResponse2008Assets} assets
   */
   ...
   * @member {Array.<module:model/InlineResponse2008Artists>} similar_artists
   */

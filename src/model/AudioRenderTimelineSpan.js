...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('tempo_change')) {
        obj['tempo_change'] = ApiClient.convertToType(data['tempo_change'], [AudioRenderTimelineSpanTempoChanges]);
      }
    }
    return obj;
  }
   ...
   * @member {Array.<module:model/AudioRenderTimelineSpanTempoChanges>} tempo_change
   */
  exports.prototype['tempo_change'] = undefined;

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ShutterstockApiReference.V2editorialvideoslicensesEditorial = factory(root.ShutterstockApiReference.ApiClient);
  }
  ...
  /**
   * The V2editorialvideoslicensesEditorial model module.
   * @module model/V2editorialvideoslicensesEditorial
   * @version 1.1.42
   */

  /**
   * Constructs a new <code>V2editorialvideoslicensesEditorial</code>.
   * Individual editorial video content to license
   * @alias module:model/V2editorialvideoslicensesEditorial
   * @class
   * @param editorial_id {String} Editorial ID
   * @param license {module:model/V2editorialvideoslicensesEditorial.LicenseEnum} License agreement to use for licensing
   */
  ...
  /**
   * Constructs a <code>V2editorialvideoslicensesEditorial</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/V2editorialvideoslicensesEditorial} obj Optional instance to populate.
   * @return {module:model/V2editorialvideoslicensesEditorial} The populated <code>V2editorialvideoslicensesEditorial</code> instance.
   */
   ...
   * @member {module:model/V2editorialvideoslicensesEditorial.LicenseEnum} license
   */
   ...
   * @member {module:model/V2editorialvideoslicensesEditorial.SizeEnum} size
   * @default 'original'
   */

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/InlineResponse20012Assets', '../model/InlineResponse200Contributor'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse20012Assets'), require('./InlineResponse200Contributor'));
  } else {
    // Browser globals (root is window)
    if (!root.ShutterstockApiReference) {
      root.ShutterstockApiReference = {};
    }
    root.ShutterstockApiReference.InlineResponse20012Data = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.InlineResponse20012Assets, root.ShutterstockApiReference.InlineResponse200Contributor);
  }
}(this, function(ApiClient, InlineResponse20012Assets, InlineResponse200Contributor) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('assets')) {
        obj['assets'] = InlineResponse20012Assets.constructFromObject(data['assets']);
      }
  ...
  /**
   * @member {module:model/InlineResponse20012Assets} assets
   */

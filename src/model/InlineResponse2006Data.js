...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/InlineResponse2006Assets', '../model/InlineResponse200Categories', '../model/InlineResponse200Contributor', '../model/InlineResponse200ModelReleases', '../model/InlineResponse200Models'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2006Assets'), require('./InlineResponse200Categories'), require('./InlineResponse200Contributor'), require('./InlineResponse200ModelReleases'), require('./InlineResponse200Models'));
  } else {
    // Browser globals (root is window)
    if (!root.ShutterstockApiReference) {
      root.ShutterstockApiReference = {};
    }
    root.ShutterstockApiReference.InlineResponse2006Data = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.InlineResponse2006Assets, root.ShutterstockApiReference.InlineResponse200Categories, root.ShutterstockApiReference.InlineResponse200Contributor, root.ShutterstockApiReference.InlineResponse200ModelReleases, root.ShutterstockApiReference.InlineResponse200Models);
  }
}(this, function(ApiClient, InlineResponse2006Assets, InlineResponse200Categories, InlineResponse200Contributor, InlineResponse200ModelReleases, InlineResponse200Models) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('assets')) {
        obj['assets'] = InlineResponse2006Assets.constructFromObject(data['assets']);
      }
      ...
      if (data.hasOwnProperty('asset_collection')) {
        obj['asset_collection'] = ApiClient.convertToType(data['asset_collection'], 'String');
      }
  ...
  /**
   * @member {module:model/InlineResponse2006Assets} assets
   */
  ...
  /**
   * Asset collection for this video
   * @member {module:model/InlineResponse2006Data.AssetCollectionEnum} asset_collection
   */
  exports.prototype['asset_collection'] = undefined;
  /**
  ...
  /**
   * Allowed values for the <code>asset_collection</code> property.
   * @enum {String}
   * @readonly
   */
  exports.AssetCollectionEnum = {
    /**
     * value: ""
     * @const
     */

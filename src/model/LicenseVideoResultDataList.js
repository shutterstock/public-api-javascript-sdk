...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/AudioDataListErrors', '../model/LicenseVideoResultDataListData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AudioDataListErrors'), require('./LicenseVideoResultDataListData'));
  } else {
    // Browser globals (root is window)
    if (!root.ShutterstockApiReference) {
      root.ShutterstockApiReference = {};
    }
    root.ShutterstockApiReference.LicenseVideoResultDataList = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.AudioDataListErrors, root.ShutterstockApiReference.LicenseVideoResultDataListData);
  }
}(this, function(ApiClient, AudioDataListErrors, LicenseVideoResultDataListData) {
  'use strict';

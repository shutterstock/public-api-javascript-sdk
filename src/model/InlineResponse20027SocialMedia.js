...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ShutterstockApiReference.InlineResponse20027SocialMedia = factory(root.ShutterstockApiReference.ApiClient);
  }
  ...
  /**
   * The InlineResponse20027SocialMedia model module.
   * @module model/InlineResponse20027SocialMedia
   * @version 1.2.0
   */

  /**
   * Constructs a new <code>InlineResponse20027SocialMedia</code>.
   * Contributor profile social media links
   * @alias module:model/InlineResponse20027SocialMedia
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse20027SocialMedia</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse20027SocialMedia} obj Optional instance to populate.
   * @return {module:model/InlineResponse20027SocialMedia} The populated <code>InlineResponse20027SocialMedia</code> instance.
   */

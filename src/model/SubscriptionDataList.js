...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/AudioDataListErrors', '../model/SubscriptionDataListData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AudioDataListErrors'), require('./SubscriptionDataListData'));
  } else {
    // Browser globals (root is window)
    if (!root.ShutterstockApiReference) {
      root.ShutterstockApiReference = {};
    }
    root.ShutterstockApiReference.SubscriptionDataList = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.AudioDataListErrors, root.ShutterstockApiReference.SubscriptionDataListData);
  }
}(this, function(ApiClient, AudioDataListErrors, SubscriptionDataListData) {
  'use strict';

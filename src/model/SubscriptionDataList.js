...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/InlineResponse200Errors', '../model/SubscriptionDataListData'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse200Errors'), require('./SubscriptionDataListData'));
  } else {
    // Browser globals (root is window)
    if (!root.ShutterstockApiReference) {
      root.ShutterstockApiReference = {};
    }
    root.ShutterstockApiReference.SubscriptionDataList = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.InlineResponse200Errors, root.ShutterstockApiReference.SubscriptionDataListData);
  }
}(this, function(ApiClient, InlineResponse200Errors, SubscriptionDataListData) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data')) {
        obj['data'] = ApiClient.convertToType(data['data'], [SubscriptionDataListData]);
      }
   ...
   * @member {Array.<module:model/SubscriptionDataListData>} data
   */

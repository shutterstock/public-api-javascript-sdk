...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/InlineResponse200Categories', '../model/InlineResponse200Errors'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse200Categories'), require('./InlineResponse200Errors'));
  } else {
    // Browser globals (root is window)
    if (!root.ShutterstockApiReference) {
      root.ShutterstockApiReference = {};
    }
    root.ShutterstockApiReference.CategoryDataList = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.InlineResponse200Categories, root.ShutterstockApiReference.InlineResponse200Errors);
  }
}(this, function(ApiClient, InlineResponse200Categories, InlineResponse200Errors) {
  'use strict';

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ShutterstockApiReference.CollectionDataListData = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.InlineResponse2005CoverItem);
  }
  ...
  /**
   * The CollectionDataListData model module.
   * @module model/CollectionDataListData
   * @version 1.5.2
   */

  /**
   * Constructs a new <code>CollectionDataListData</code>.
   * Metadata about a collection of assets
   * @alias module:model/CollectionDataListData
   * @class
  ...
  /**
   * Constructs a <code>CollectionDataListData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CollectionDataListData} obj Optional instance to populate.
   * @return {module:model/CollectionDataListData} The populated <code>CollectionDataListData</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('cover_item')) {
        obj['cover_item'] = InlineResponse2005CoverItem.constructFromObject(data['cover_item']);
      }
  ...
  /**
   * @member {module:model/InlineResponse2005CoverItem} cover_item
   */
  ...
  /**
   * The last time the collection was updated (other than changes to the items in it)

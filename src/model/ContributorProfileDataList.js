...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/ContributorProfileDataListData', '../model/InlineResponse200Errors'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ContributorProfileDataListData'), require('./InlineResponse200Errors'));
  } else {
    // Browser globals (root is window)
    if (!root.ShutterstockApiReference) {
      root.ShutterstockApiReference = {};
    }
    root.ShutterstockApiReference.ContributorProfileDataList = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.ContributorProfileDataListData, root.ShutterstockApiReference.InlineResponse200Errors);
  }
}(this, function(ApiClient, ContributorProfileDataListData, InlineResponse200Errors) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data')) {
        obj['data'] = ApiClient.convertToType(data['data'], [ContributorProfileDataListData]);
      }
   ...
   * @member {Array.<module:model/ContributorProfileDataListData>} data
   */

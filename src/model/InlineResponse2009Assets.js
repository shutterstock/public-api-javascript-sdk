...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ShutterstockApiReference.InlineResponse2009Assets = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.InlineResponse2009AssetsAlbumArt, root.ShutterstockApiReference.InlineResponse2009AssetsShortsLoopsStems);
  }
  ...
  /**
   * The InlineResponse2009Assets model module.
   * @module model/InlineResponse2009Assets
   * @version 1.1.42
   */

  /**
   * Constructs a new <code>InlineResponse2009Assets</code>.
   * Files that are available as part of an audio asset
   * @alias module:model/InlineResponse2009Assets
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2009Assets</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2009Assets} obj Optional instance to populate.
   * @return {module:model/InlineResponse2009Assets} The populated <code>InlineResponse2009Assets</code> instance.
   */

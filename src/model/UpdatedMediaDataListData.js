...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ShutterstockApiReference.UpdatedMediaDataListData = factory(root.ShutterstockApiReference.ApiClient);
  }
  ...
  /**
   * The UpdatedMediaDataListData model module.
   * @module model/UpdatedMediaDataListData
   * @version 1.2.0
   */

  /**
   * Constructs a new <code>UpdatedMediaDataListData</code>.
   * Information about a piece of updated media
   * @alias module:model/UpdatedMediaDataListData
   * @class
  ...
  /**
   * Constructs a <code>UpdatedMediaDataListData</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdatedMediaDataListData} obj Optional instance to populate.
   * @return {module:model/UpdatedMediaDataListData} The populated <code>UpdatedMediaDataListData</code> instance.
   */

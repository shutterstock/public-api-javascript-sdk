...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Shutterstock.Image = factory(root.Shutterstock.ApiClient, root.Shutterstock.Category, root.Shutterstock.Contributor, root.Shutterstock.ImageAssets, root.Shutterstock.Model, root.Shutterstock.ModelRelease);
  }
   ...
   */
  var exports = function(contributor, id, mediaType) {
    var _this = this;

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/Category', '../model/Contributor', '../model/ImageAssets', '../model/ImageInsights', '../model/Model', '../model/ModelRelease'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Category'), require('./Contributor'), require('./ImageAssets'), require('./ImageInsights'), require('./Model'), require('./ModelRelease'));
  } else {
    // Browser globals (root is window)
    if (!root.ShutterstockApiReference) {
      root.ShutterstockApiReference = {};
    }
    root.ShutterstockApiReference.Image = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.Category, root.ShutterstockApiReference.Contributor, root.ShutterstockApiReference.ImageAssets, root.ShutterstockApiReference.ImageInsights, root.ShutterstockApiReference.Model, root.ShutterstockApiReference.ModelRelease);
  }
}(this, function(ApiClient, Category, Contributor, ImageAssets, ImageInsights, Model, ModelRelease) {
  'use strict';

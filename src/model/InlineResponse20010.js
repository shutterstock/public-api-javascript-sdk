...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/InlineResponse2009Album', '../model/InlineResponse2009Artists', '../model/InlineResponse2009Assets', '../model/InlineResponse200Contributor', '../model/InlineResponse200ModelReleases'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./InlineResponse2009Album'), require('./InlineResponse2009Artists'), require('./InlineResponse2009Assets'), require('./InlineResponse200Contributor'), require('./InlineResponse200ModelReleases'));
  } else {
    // Browser globals (root is window)
    if (!root.ShutterstockApiReference) {
      root.ShutterstockApiReference = {};
    }
    root.ShutterstockApiReference.InlineResponse20010 = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.InlineResponse2009Album, root.ShutterstockApiReference.InlineResponse2009Artists, root.ShutterstockApiReference.InlineResponse2009Assets, root.ShutterstockApiReference.InlineResponse200Contributor, root.ShutterstockApiReference.InlineResponse200ModelReleases);
  }
}(this, function(ApiClient, InlineResponse2009Album, InlineResponse2009Artists, InlineResponse2009Assets, InlineResponse200Contributor, InlineResponse200ModelReleases) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('album')) {
        obj['album'] = InlineResponse2009Album.constructFromObject(data['album']);
      }
      if (data.hasOwnProperty('artists')) {
        obj['artists'] = ApiClient.convertToType(data['artists'], [InlineResponse2009Artists]);
      }
      if (data.hasOwnProperty('assets')) {
        obj['assets'] = InlineResponse2009Assets.constructFromObject(data['assets']);
      }
      ...
      if (data.hasOwnProperty('similar_artists')) {
        obj['similar_artists'] = ApiClient.convertToType(data['similar_artists'], [InlineResponse2009Artists]);
      }
  ...
  /**
   * @member {module:model/InlineResponse2009Album} album
   */
  exports.prototype['album'] = undefined;
  /**
   * List of artists
   * @member {Array.<module:model/InlineResponse2009Artists>} artists
   */
  exports.prototype['artists'] = undefined;
  /**
   * @member {module:model/InlineResponse2009Assets} assets
   */
   ...
   * @member {Array.<module:model/InlineResponse2009Artists>} similar_artists
   */

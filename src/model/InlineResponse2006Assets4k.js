...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ShutterstockApiReference.InlineResponse2006Assets4k = factory(root.ShutterstockApiReference.ApiClient);
  }
  ...
  /**
   * The InlineResponse2006Assets4k model module.
   * @module model/InlineResponse2006Assets4k
   * @version 1.2.0
   */

  /**
   * Constructs a new <code>InlineResponse2006Assets4k</code>.
   * Video asset information
   * @alias module:model/InlineResponse2006Assets4k
   * @class
   */
  ...
  /**
   * Constructs a <code>InlineResponse2006Assets4k</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/InlineResponse2006Assets4k} obj Optional instance to populate.
   * @return {module:model/InlineResponse2006Assets4k} The populated <code>InlineResponse2006Assets4k</code> instance.
   */

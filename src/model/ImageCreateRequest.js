...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Shutterstock.ImageCreateRequest = factory(root.Shutterstock.ApiClient);
  }
   ...
   * @class
   * @param base64Image {String} A Base64 encoded jpeg or png
   */
  var exports = function(base64Image) {
    var _this = this;

    _this['base64_image'] = base64Image;
  };

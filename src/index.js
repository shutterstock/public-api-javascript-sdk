...
(function(factory) {
   ...
   * <pre>
   * var Shutterstock = require('index'); // See note below*.
   * var xxxSvc = new Shutterstock.XxxApi(); // Allocate the API class we're going to use.
   * var yyyModel = new Shutterstock.Yyy(); // Construct a model instance.
   ...
   * <pre>
   * var xxxSvc = new Shutterstock.XxxApi(); // Allocate the API class we're going to use.
   * var yyy = new Shutterstock.Yyy(); // Construct a model instance.
   * yyyModel.someProperty = 'someValue';
   * ...
   * var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
   * ...
  ...
  var exports = {
    ...
    /**
     * The LicenseAgreement model constructor.
     * @property {module:model/LicenseAgreement}
     */

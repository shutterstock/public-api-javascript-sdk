...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/Audio', '../model/AudioDataList', '../model/AudioSearchResults', '../model/AudioUrl', '../model/Collection', '../model/CollectionCreateRequest', '../model/CollectionCreateResponse', '../model/CollectionDataList', '../model/CollectionItemDataList', '../model/CollectionItemRequest', '../model/CollectionUpdateRequest', '../model/DownloadHistoryDataList', '../model/GenreList', '../model/InstrumentList', '../model/LicenseAudioRequest', '../model/LicenseAudioResultDataList', '../model/MoodList'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Audio'), require('../model/AudioDataList'), require('../model/AudioSearchResults'), require('../model/AudioUrl'), require('../model/Collection'), require('../model/CollectionCreateRequest'), require('../model/CollectionCreateResponse'), require('../model/CollectionDataList'), require('../model/CollectionItemDataList'), require('../model/CollectionItemRequest'), require('../model/CollectionUpdateRequest'), require('../model/DownloadHistoryDataList'), require('../model/GenreList'), require('../model/InstrumentList'), require('../model/LicenseAudioRequest'), require('../model/LicenseAudioResultDataList'), require('../model/MoodList'));
  } else {
    // Browser globals (root is window)
    if (!root.ShutterstockApiReference) {
      root.ShutterstockApiReference = {};
    }
    root.ShutterstockApiReference.AudioApi = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.Audio, root.ShutterstockApiReference.AudioDataList, root.ShutterstockApiReference.AudioSearchResults, root.ShutterstockApiReference.AudioUrl, root.ShutterstockApiReference.Collection, root.ShutterstockApiReference.CollectionCreateRequest, root.ShutterstockApiReference.CollectionCreateResponse, root.ShutterstockApiReference.CollectionDataList, root.ShutterstockApiReference.CollectionItemDataList, root.ShutterstockApiReference.CollectionItemRequest, root.ShutterstockApiReference.CollectionUpdateRequest, root.ShutterstockApiReference.DownloadHistoryDataList, root.ShutterstockApiReference.GenreList, root.ShutterstockApiReference.InstrumentList, root.ShutterstockApiReference.LicenseAudioRequest, root.ShutterstockApiReference.LicenseAudioResultDataList, root.ShutterstockApiReference.MoodList);
  }
}(this, function(ApiClient, Audio, AudioDataList, AudioSearchResults, AudioUrl, Collection, CollectionCreateRequest, CollectionCreateResponse, CollectionDataList, CollectionItemDataList, CollectionItemRequest, CollectionUpdateRequest, DownloadHistoryDataList, GenreList, InstrumentList, LicenseAudioRequest, LicenseAudioResultDataList, MoodList) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/AudioUrl} and HTTP response
     */
     ...
     * This endpoint redownloads tracks that you have already received a license for. The download links in the response are valid for 8 hours.
     * @param {String} id License ID
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/AudioUrl}
     */
     ...
     * @param {String} opts.license Restrict results by license. Prepending a `-` sign will exclude results by license
     * @param {Number} opts.page Page number (default to 1)

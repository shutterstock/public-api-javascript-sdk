...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Shutterstock.AudioApi = factory(root.Shutterstock.ApiClient, root.Shutterstock.Audio, root.Shutterstock.AudioDataList, root.Shutterstock.AudioSearchResults, root.Shutterstock.Collection, root.Shutterstock.CollectionCreateRequest, root.Shutterstock.CollectionCreateResponse, root.Shutterstock.CollectionDataList, root.Shutterstock.CollectionItemDataList, root.Shutterstock.CollectionItemRequest, root.Shutterstock.CollectionUpdateRequest, root.Shutterstock.DownloadHistoryDataList, root.Shutterstock.LicenseAudioRequest, root.Shutterstock.LicenseAudioResultDataList, root.Shutterstock.Url);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @param {Array.<String>} opts.itemId One or more item IDs to remove from the collection
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.audioId Show licenses for the specified track ID
     ...
     * @param {String} opts.searchId The ID of the search that led to licensing this track
     ...
     * @param {Number} opts.bpmFrom Show tracks with the specified beats per minute or faster
     * @param {Number} opts.bpmTo Show tracks with the specified beats per minute or slower
     * @param {Number} opts.duration Show tracks with the specified duration (seconds)
     * @param {Number} opts.durationFrom Show tracks with the specified duration or longer (seconds)
     * @param {Number} opts.durationTo Show tracks with the specified duration or shorter (seconds)
     * @param {Array.<module:model/String>} opts.genre Show tracks with each of the specified genres
     * @param {Boolean} opts.isInstrumental Show instrumental music only
     ...
     * @param {module:model/String} opts.sortOrder Sort order, asc or desc (default to desc)
     * @param {String} opts.vocalDescription Show tracks with the specified vocal description (male, female)
     * @param {module:model/String} opts.view Amount of detail to render in the response (only for accounts with subscriptions) (default to minimal)

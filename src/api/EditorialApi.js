...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {Array.<String>} opts.supplierCode Show only editorial content from certain suppliers
     * @param {Date} opts.dateStart Show only editorial content generated on or after a specific date, in the format of YYYY-MM-DD
     * @param {Date} opts.dateEnd Show only editorial content generated on or before a specific date, in the format of YYYY-MM-DD
     * @param {Number} opts.perPage Number of results per page, defaults to 20 (default to 20)

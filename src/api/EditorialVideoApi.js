...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/DownloadHistoryDataList', '../model/EditorialVideoCategoryResults', '../model/EditorialVideoContent', '../model/EditorialVideoResults', '../model/EditorialVideoSearchResults', '../model/LicenseEditorialContentResults', '../model/LicenseEditorialVideoContentRequest'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/DownloadHistoryDataList'), require('../model/EditorialVideoCategoryResults'), require('../model/EditorialVideoContent'), require('../model/EditorialVideoResults'), require('../model/EditorialVideoSearchResults'), require('../model/LicenseEditorialContentResults'), require('../model/LicenseEditorialVideoContentRequest'));
  } else {
    // Browser globals (root is window)
    if (!root.ShutterstockApiReference) {
      root.ShutterstockApiReference = {};
    }
    root.ShutterstockApiReference.EditorialVideoApi = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.DownloadHistoryDataList, root.ShutterstockApiReference.EditorialVideoCategoryResults, root.ShutterstockApiReference.EditorialVideoContent, root.ShutterstockApiReference.EditorialVideoResults, root.ShutterstockApiReference.EditorialVideoSearchResults, root.ShutterstockApiReference.LicenseEditorialContentResults, root.ShutterstockApiReference.LicenseEditorialVideoContentRequest);
  }
}(this, function(ApiClient, DownloadHistoryDataList, EditorialVideoCategoryResults, EditorialVideoContent, EditorialVideoResults, EditorialVideoSearchResults, LicenseEditorialContentResults, LicenseEditorialVideoContentRequest) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.search_id The ID of the search that is related to this request
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/EditorialVideoResults} and HTTP response
     */
    this.listEditorialVideosWithHttpInfo = function(id, country, opts) {
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = EditorialVideoResults;
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.search_id The ID of the search that is related to this request
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/EditorialVideoResults}
     */

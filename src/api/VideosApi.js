...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {Object} opts Optional parameters
     * @param {Date} opts.added_date Show videos added on the specified date, in the format YYYY-MM-DD
     ...
     * @param {Array.<String>} opts.contributor_country Show videos from contributors in one or more specified countries by 2-letter ISO 3166-1 alpha-2 country code, such as DE or US
     ...
     * @param {Number} opts.duration_to Show videos with the specified duration or shorter (seconds)
     ...
     * @param {module:model/String} opts.people_ethnicity Show videos with people of the specified ethnicity

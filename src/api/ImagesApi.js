...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {Array.<String>} opts.itemId One or more image IDs to remove from the collection
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
     ...
     * @param {module:model/String} opts.assetHint Cover image size, defaults to 1x (default to 1x)
     ...
     * @param {Number} opts.perPage Number of results per page, defaults to 100 (default to 100)
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.imageId Show licenses for the specified image ID
     ...
     * @param {Number} opts.page Page number (default to 1)
     * @param {Number} opts.perPage Number of results per page, defaults to 20 (default to 20)
     ...
     * @param {Object} opts Optional parameters
     * @param {Number} opts.maxItems Maximum number of results returned in the response (default to 20)
     ...
     * @param {String} opts.shareCode Code to retrieve a shared collection
     ...
     * @param {String} id Collection ID
     * @param {Object} opts Optional parameters
     * @param {String} opts.shareCode Code to retrieve the contents of a shared collection
     * @param {Number} opts.page Page number (default to 1)
     * @param {Number} opts.perPage Number of results per page, defaults to 100 (default to 100)
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/CollectionItemDataList} and HTTP response
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.subscriptionId Subscription ID to use to license the image
     * @param {module:model/String} opts.format Image format, defaults to jpg (default to jpg)
     * @param {module:model/String} opts.size Image size (default to huge)
     * @param {String} opts.searchId Search ID that was provided in the results of an image search
     ...
     * @param {Object} opts Optional parameters
     * @param {Date} opts.addedDate Show images added on the specified date, in the format YYYY-MM-DD
     * @param {Date} opts.addedDateStart Show images added on or after the specified date, in the format YYYY-MM-DD
     * @param {Date} opts.addedDateEnd Show images added before the specified date, in the format YYYY-MM-DD
     ...
     * @param {Number} opts.heightFrom Show images with the specified height or larger, in pixels
     * @param {Number} opts.heightTo Show images with the specified height or smaller, in pixels
     * @param {Array.<module:model/String>} opts.imageType Show images of the specified type
     ...
     * @param {Number} opts.page Page number (default to 1)
     * @param {Number} opts.perPage Number of results per page, defaults to 20 (default to 20)
     * @param {Boolean} opts.peopleModelReleased Show images of people with a signed model release
     * @param {module:model/String} opts.peopleAge Show images that feature people of the specified age category
     * @param {module:model/String} opts.peopleEthnicity Show images with people of the specified ethnicity
     * @param {module:model/String} opts.peopleGender Show images with people of the specified gender
     * @param {Number} opts.peopleNumber Show images with the specified number of people
     ...
     * @param {Boolean} opts.spellcheckQuery Spellcheck the search query and return results on suggested spellings (default to true)
     * @param {module:model/String} opts.view Amount of detail to render in the response (only for accounts with subscriptions) (default to minimal)
     * @param {Number} opts.width (Deprecated; use width_from and width_to instead) Show images with the specified width
     * @param {Number} opts.widthFrom Show images with the specified width or larger, in pixels
     * @param {Number} opts.widthTo Show images with the specified width or smaller, in pixels
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/ImageSearchResults} and HTTP response
     */

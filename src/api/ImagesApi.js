...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/String} opts.people_ethnicity Show images with people of the specified ethnicity
    ...
    this.searchImagesWithHttpInfo = function(opts) {
      ...
      var queryParams = {
        ...
        'people_ethnicity': opts['people_ethnicity'],

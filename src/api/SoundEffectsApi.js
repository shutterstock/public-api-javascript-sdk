...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/DownloadHistoryDataList', '../model/LicenseSFXRequest', '../model/LicenseSFXResultDataList', '../model/SFX', '../model/SFXDataList', '../model/SFXSearchResults'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/DownloadHistoryDataList'), require('../model/LicenseSFXRequest'), require('../model/LicenseSFXResultDataList'), require('../model/SFX'), require('../model/SFXDataList'), require('../model/SFXSearchResults'));
  } else {
    // Browser globals (root is window)
    if (!root.ShutterstockApiReference) {
      root.ShutterstockApiReference = {};
    }
    root.ShutterstockApiReference.SoundEffectsApi = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.DownloadHistoryDataList, root.ShutterstockApiReference.LicenseSFXRequest, root.ShutterstockApiReference.LicenseSFXResultDataList, root.ShutterstockApiReference.SFX, root.ShutterstockApiReference.SFXDataList, root.ShutterstockApiReference.SFXSearchResults);
  }
}(this, function(ApiClient, DownloadHistoryDataList, LicenseSFXRequest, LicenseSFXResultDataList, SFX, SFXDataList, SFXSearchResults) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {String} opts.license Show sound effects that are available with the specified license, such as `standard` or `enhanced`; prepending a `-` sign excludes results from that license

...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/Body19', '../model/InlineResponse200', '../model/InlineResponse2006', '../model/InlineResponse2011'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Body19'), require('../model/InlineResponse200'), require('../model/InlineResponse2006'), require('../model/InlineResponse2011'));
  } else {
    // Browser globals (root is window)
    if (!root.ShutterstockApiReference) {
      root.ShutterstockApiReference = {};
    }
    root.ShutterstockApiReference.ComputerVisionApi = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.Body19, root.ShutterstockApiReference.InlineResponse200, root.ShutterstockApiReference.InlineResponse2006, root.ShutterstockApiReference.InlineResponse2011);
  }
}(this, function(ApiClient, Body19, InlineResponse200, InlineResponse2006, InlineResponse2011) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/Body19} body A Base 64 encoded jpeg or png; images can be no larger than 10mb and can be no larger than 10,000 pixels in width or height

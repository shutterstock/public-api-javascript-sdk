...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/DownloadHistoryDataList', '../model/EditorialCategoryResults', '../model/EditorialContent', '../model/EditorialContentDataList', '../model/EditorialImageCategoryResults', '../model/EditorialImageContentDataList', '../model/EditorialImageLivefeed', '../model/EditorialImageLivefeedList', '../model/EditorialImageResults', '../model/EditorialLivefeed', '../model/EditorialLivefeedList', '../model/EditorialSearchResults', '../model/EditorialUpdatedResults', '../model/LicenseEditorialContentRequest', '../model/LicenseEditorialContentResults'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/DownloadHistoryDataList'), require('../model/EditorialCategoryResults'), require('../model/EditorialContent'), require('../model/EditorialContentDataList'), require('../model/EditorialImageCategoryResults'), require('../model/EditorialImageContentDataList'), require('../model/EditorialImageLivefeed'), require('../model/EditorialImageLivefeedList'), require('../model/EditorialImageResults'), require('../model/EditorialLivefeed'), require('../model/EditorialLivefeedList'), require('../model/EditorialSearchResults'), require('../model/EditorialUpdatedResults'), require('../model/LicenseEditorialContentRequest'), require('../model/LicenseEditorialContentResults'));
  } else {
    // Browser globals (root is window)
    if (!root.ShutterstockApiReference) {
      root.ShutterstockApiReference = {};
    }
    root.ShutterstockApiReference.EditorialImagesApi = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.DownloadHistoryDataList, root.ShutterstockApiReference.EditorialCategoryResults, root.ShutterstockApiReference.EditorialContent, root.ShutterstockApiReference.EditorialContentDataList, root.ShutterstockApiReference.EditorialImageCategoryResults, root.ShutterstockApiReference.EditorialImageContentDataList, root.ShutterstockApiReference.EditorialImageLivefeed, root.ShutterstockApiReference.EditorialImageLivefeedList, root.ShutterstockApiReference.EditorialImageResults, root.ShutterstockApiReference.EditorialLivefeed, root.ShutterstockApiReference.EditorialLivefeedList, root.ShutterstockApiReference.EditorialSearchResults, root.ShutterstockApiReference.EditorialUpdatedResults, root.ShutterstockApiReference.LicenseEditorialContentRequest, root.ShutterstockApiReference.LicenseEditorialContentResults);
  }
}(this, function(ApiClient, DownloadHistoryDataList, EditorialCategoryResults, EditorialContent, EditorialContentDataList, EditorialImageCategoryResults, EditorialImageContentDataList, EditorialImageLivefeed, EditorialImageLivefeedList, EditorialImageResults, EditorialLivefeed, EditorialLivefeedList, EditorialSearchResults, EditorialUpdatedResults, LicenseEditorialContentRequest, LicenseEditorialContentResults) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.search_id The ID of the search that is related to this request
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/EditorialImageResults} and HTTP response
     */
    this.listEditorialImagesWithHttpInfo = function(id, country, opts) {
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = EditorialImageResults;
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.search_id The ID of the search that is related to this request
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/EditorialImageResults}
     */

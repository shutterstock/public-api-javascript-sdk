...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['../ApiClient', '../model/Body17', '../model/Body24', '../model/InlineResponse20015', '../model/InlineResponse20016', '../model/InlineResponse20017', '../model/InlineResponse20018', '../model/InlineResponse20019', '../model/InlineResponse20020', '../model/InlineResponse20021', '../model/InlineResponse20033', '../model/InlineResponse20034'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Body17'), require('../model/Body24'), require('../model/InlineResponse20015'), require('../model/InlineResponse20016'), require('../model/InlineResponse20017'), require('../model/InlineResponse20018'), require('../model/InlineResponse20019'), require('../model/InlineResponse20020'), require('../model/InlineResponse20021'), require('../model/InlineResponse20033'), require('../model/InlineResponse20034'));
  } else {
    // Browser globals (root is window)
    if (!root.ShutterstockApiReference) {
      root.ShutterstockApiReference = {};
    }
    root.ShutterstockApiReference.EditorialImagesApi = factory(root.ShutterstockApiReference.ApiClient, root.ShutterstockApiReference.Body17, root.ShutterstockApiReference.Body24, root.ShutterstockApiReference.InlineResponse20015, root.ShutterstockApiReference.InlineResponse20016, root.ShutterstockApiReference.InlineResponse20017, root.ShutterstockApiReference.InlineResponse20018, root.ShutterstockApiReference.InlineResponse20019, root.ShutterstockApiReference.InlineResponse20020, root.ShutterstockApiReference.InlineResponse20021, root.ShutterstockApiReference.InlineResponse20033, root.ShutterstockApiReference.InlineResponse20034);
  }
}(this, function(ApiClient, Body17, Body24, InlineResponse20015, InlineResponse20016, InlineResponse20017, InlineResponse20018, InlineResponse20019, InlineResponse20020, InlineResponse20021, InlineResponse20033, InlineResponse20034) {
  'use strict';
